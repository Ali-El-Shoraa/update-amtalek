...
export default function ComboBox({
  ...
  useEffect(() => {
    ...
    if (title) {
      const matchingOption = options.find(
        (option: any) => option.value === parseInt(title)
      );
      if (matchingOption) {
  ...
  const toggleSelection = useCallback(
    (selectedId: any) => {
      const newSelectedId =
        selectedLocationId === selectedId ? null : selectedId;
      ...
      if (newSelectedId) {
        updatedParams.set(getDefaultValueFromURL, newSelectedId.toString());
      } else {
      ...
      <PopoverTrigger asChild className={`${width}`}>
        ...
        >
          ...
          >
            {selectedLocationId
              ? options.find(
                  (option: any) => option.value === selectedLocationId
                )?.label
              : placeholder}
          </span>
...
//       setOpen(false);
//     },
//     [selectedLocationId, setValue, stateName, setSearchParams, callBcFn]
//   );
...
//       callBcFn(null);
//     }
//   }, [setValue, stateName, setSearchParams, callBcFn]);
...
//           {/* شرط إظهار زر X لإلغاء التحديد */}
//           {selectedLocationId ? (
//             <X
//               onClick={(e) => {
//                 e.stopPropagation(); // منع فتح القائمة عند النقر على X
//                 clearSelection();
//               }}
//               className="text-secondary cursor-pointer"
//             />
...
// import { Check, X } from "lucide-react"; // إضافة رمز X
// import { cn } from "@/lib/utils";
// import { Button } from "@/components/ui/button";
// import {
//   Command,
...
//   const toggleSelection = (selectedId: any) => {
//     const newSelectedId = selectedLocationId === selectedId ? null : selectedId;
//     setSelectedLocationId(newSelectedId);
